...
ARTIFACT_KINDS = frozenset({
    "custom_field", "property_setter", "doctype", "page", "query_report",
    "script_report", "print_format", "web_page", "web_form", "office_artifact",
})
...
class ArtifactChangeSet:
    ...
    def from_dict(cls, value: Mapping[str, Any]) -> "ArtifactChangeSet":
        if set(value) - {"schema_version", "target_site", "actor", "mission", "artifacts"}:
